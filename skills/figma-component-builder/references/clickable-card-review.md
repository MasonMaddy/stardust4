...
| 5 | Title/subtitle typography | **Align** | Card reuses **ds-title-block as-is** (title medium 500, subtitle 14px regular — Subtitle/Regular since 2026-06-12, green minimal pills). Card-local 20px title / 12px primary subtitle in Figma is drift to fix. |
