  ...
  function CalendarCard() {
    ...
    return (
      ...
      >
        ...
        <StateNote text={
          'One ds-calendar replaces the legacy two-foundation split: Calendar (a Vue Cal wrapper) and CalendarMonthly (an undocumented, heavily modified Vuetify calendar) did the same job on different foundations. This card was the design exploration for that replacement. Decision (Mason, 2026-07-06): **Operational ships as the default direction.** Clean and Soft remain viewable here as the exploration record until extraction. All three directions run identical data, month logic, keyboard model and class contract; direction is a pure CSS modifier. '
